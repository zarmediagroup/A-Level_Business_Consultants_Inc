          ...
          <body style="font-family: Arial, sans-serif; background: #f0f2f8; padding: 40px 20px;">
            <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
              <div style="background: linear-gradient(135deg, #0f172a, #1e293b); padding: 32px; text-align: center;">
                <div style="width: 48px; height: 48px; background: #ffffff; border-radius: 8px; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 16px;">
                  <span style="color: #0f172a; font-weight: bold; font-size: 14px;">AL</span>
                </div>
              ...
              <div style="padding: 32px;">
                <p style="color: #0f172a; font-size: 15px; margin-top: 0;">
                ...
                <div style="background: #f8fafc; border-radius: 12px; padding: 20px; margin: 20px 0; border-left: 4px solid #1d4ed8;">
                  ...
                  <p style="margin: 0 0 16px; font-size: 15px; font-weight: 600; color: #0f172a;">${fileName}</p>
                  <p style="margin: 0 0 8px; font-size: 13px; color: #64748b;">Category</p>
                  <p style="margin: 0; font-size: 15px; font-weight: 600; color: #0f172a; text-transform: capitalize;">${category?.replace(/_/g, " ") ?? "Other"}</p>
                </div>
                <a href="${portalUrl}" style="display: block; background: #1d4ed8; color: #ffffff; text-align: center; padding: 14px 24px; border-radius: 8px; font-weight: 600; font-size: 14px; text-decoration: none; margin-top: 24px;">
