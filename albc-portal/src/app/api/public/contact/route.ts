        ...
        <body style="font-family: Arial, sans-serif; background: #f0f2f8; padding: 40px 20px;">
          <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 16px; overflow: hidden;">
            ...
            <div style="padding: 32px;">
              ...
              <div style="margin-top: 20px; padding: 16px; background: #f8fafc; border-radius: 12px; border-left: 4px solid #1d4ed8;">
      ...
      html: `
        ...
        <body style="font-family: Arial, sans-serif; background: #f0f2f8; padding: 40px 20px;">
          <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 16px; overflow: hidden;">
            ...
            <div style="padding: 32px;">
              <p style="color: #0f172a; font-size: 15px;">We've received your enquiry and will be in touch within <strong>1 business day</strong>.</p>
              <p style="color: #64748b; font-size: 14px; line-height: 1.6;">In the meantime, if you have an urgent query, please call us directly or email <a href="mailto:info@albc.co.za" style="color: #1d4ed8;">info@albc.co.za</a>.</p>
