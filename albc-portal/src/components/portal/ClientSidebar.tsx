...
export default function ClientSidebar({ clientName = "Client", unreadCount = 0 }: ClientSidebarProps) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-5 py-6 border-b border-slate-800">
        ...
        <div>
          ...
          <div className="text-blue-200/90 text-[10px] tracking-[0.15em] uppercase">Client Portal</div>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "lg:hidden fixed left-0 top-0 bottom-0 z-50 w-64 bg-slate-950 border-r border-slate-800 transition-transform duration-300",
